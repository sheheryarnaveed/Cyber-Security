...
function submit_score(){
	...
	$.post("https://gameserver2048.herokuapp.com/submit", {username: username, score: player.score, grid: "{}"}, function (data, textStatus) {
		try {
...
function load_high_scores() {
	$.getJSON("https://gameserver2048.herokuapp.com/scores.json?username=" + username, function(json) {
		scores = json;
