...
<html>
<head>
<title>2018 CTF Scoreboard</title>
...
<body>
<h1>2018 CTF Scoreboard</h1>
<?php
    $deduction = -100;
    $actualtampertoken = "skymanatees";
    $submitkeys = array('desertrose','holly','nandina', 'chinesefir', 'firethorn', 'pinkdogwood', 'teaolive', 'floweringpeach', 'flowingcrabapple', 'magnolia', 'juniper', 'pampas', 'yellowjasmine', 'carolinacherry', 'camellia', 'whitedogwood', 'goldenbell', 'yellowroseoftexas','general', 'ella');
    $error = false;
    $success = false;
    $tamper = false;
    if (!empty($_POST)) {
        ...
        if (in_array($submitkey, $submitkeys)) {
            ...
            $myUserName = "ctf2018scoreboard";
            $myPassword = 'ImOnlyHuman2018';
            ...
            $query = "SELECT id, points FROM ctf_flags WHERE LOWER(flag) = '" . mysqli_real_escape_string($db, strtolower($submitflag)) . "'";
...
<p>Challenge 2: Just .git it. <span class="points">150 points</span></p>
<p>Challenge 3: All your base64 are belong to us. <span class="points">200 points</span></p>
<p>Challenge 4: Don't ask me if something looks wrong.  Look again, pay careful attention. <span class="points">200 points</span></p>
<p>Challenge 5: Don't ask me if something looks wrong.  Look again, pay really careful attention. <span class="points">300 points</span>
</p>
<p>Challenge 6: Don't forget to logout too! <span class="points">100 points</span></p>
<p>Challenge 7: Buried in the dump of uploads, hash of ace of spades. <span class="points">150 points</span></p>
<p>Challenge 8: Buried in the dump: needle in the haystack. <span class="points">300 points</span></p>
<p>Challenge 9: About my friend bobo... <span class="points">200 points</span></p>
<p>Challenge 10: Not Global Thermal Nuclear War. <span class="points">100 points</span></p>
<p>Challenge 11: MongoDB. Enough said. <span class="points">200 points</span></p>
<h2>Scores</h2>
<table>
<tr>
<th>Team Number</th>
